...
zip OfficeVitaeMongooseSchemaDesigner.zip OfficevitaeMongooseSchemaDesigner.jar libs/rhino-1.7.9.jar *.msd
echo "To distribute Office Vitae Mongoose Schema Designer send the OfficeVitaeMongooseSchemaDesigner.zip file."
